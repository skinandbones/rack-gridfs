...
files based on either their +id+ or +filename+ field.
...
- +disposition+: content disposition http header type which is <tt>:attachment</tt> or <tt>:inline</tt>.
   Default is <tt>:inline</tt>.
